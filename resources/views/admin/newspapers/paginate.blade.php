...
<tr>
   ...
   <td>
      <div class="d-flex align-items-center">
         {!! date('d F Y',strtotime($row->paper_date)) !!} - {!! date('d F Y',strtotime($row->end_date)) !!}
      </div>
   </td>
   ...
   <td>
      <a href="{{ url('/admin/edit-newspaper',base64_encode($row->id)) }}" class="btn btn-sm btn-primary" title="Edit">
